...
// Loop to execute the test case multiple times
for (int i = 1; i <= numberOfRuns; i++) {
	println("Execution Run: " + i) // Logs the iteration number
...
// Clear the file content before starting (optional, to avoid appending to old data)
File file = new File("C:\\Katalon Studio\\ParaBank Testing\\Data Files\\output.txt")
file.text = ''

// Inside the loop, add this line to append each email to the file:
file << Email + "\n"
